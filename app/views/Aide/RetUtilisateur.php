		...
		<div class="row">
			<div class="col-12 col-m-12">
				<div class="col-12 col-m-12 box headBox bgorange">
					<div class="col-m-10">
						<h1 class="NavBar">RETIRER UN UTILISATEUR</h1>
					</div>
					<div class="col-m-2">
			...
			<div class="col-12 col-m-12">
				<h4 class="CLorange">Comment faire ?</h4><hr>
					...
					<p>Pour retirer un utilisateur, Vous devez vous rendre ne premier lieu dans la page de configuration. Ensuite, cliquer sur utilisateur pour ensuite cliquer sur MODIFIER.</p>

					<h4 class="CLorange">Comment utiliser cette fonction ?</h4><hr>

					<p>Une fois sur la page, sélectionnez l'utilisateur que vous désirez retirer. Par la suite cliquer sur le bouton retirer.</p>
