		...
		<div class="row">
			<div class="col-12 col-m-12">
				<div class="col-12 col-m-12 box headBox bgorange">
					<div class="col-m-10">
						<h1 class="NavBar">Ajouter un utilisateur</h1>
					</div>
					<div class="col-m-2">
			...
			<div class="col-12 col-m-12">
				<h4 class="CLorange">Comment faire ?</h4><hr>
					...
					<p>Pour ajouter un utilisateur, Vous devez vous rendre ne premier lieu dans la page de configuration. Ensuite, cliquer sur utilisateur pour ensuite cliquer sur ajouter un utilisateur.</p>

					<h4 class="CLorange">Comment utiliser cette fonction ?</h4><hr>

					<p>Une fois dans la bonne page, remplisez le formulaire d'ajout. Une fois cela fait, votre nouvelle utilisateur est enregistré. Vous pouvez dès maintenant l'utiliser.</p>

					<h4 class="CLorange">Lien rapide !</h4><hr>

					<a href="/index.php/Home/InsertionUtilisateur"><button class="stylebtn bgorange">Y allez !</button></a>
