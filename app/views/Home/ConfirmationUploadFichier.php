	...
	<div class="row">
		...
		<div class="col-6 col-m-12">
			...
			<div class="col-12 col-m-12 box" align="center">
				<h1 class="CLOrange">La base de donnée est remplacée</h1>
				<a href="/index.php/Admin/RetourMenu"><button class="StyleBtn BGOrange">Retourner au menu principal</button></a>
			</div>
		</div>
		<div class="col-3 col-m-12"></div>
	</div>
