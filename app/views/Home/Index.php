...
<div class="row">
	<div class="col-3 col-m-12">
		<div class="col-12 col-m-12 box">
			...
			<h3 onclick=" HideDivSR('Div1')" class="clOrange">Recherche avancé <img id="arrSR3" style="width: 12px;height: 12px;" src="/images/icon/arrow-icon.png"></h3>
	...
	<div class="col-9 col-m-12">		
		<div id="Main" class="col-12 col-m-12 maxheight overflowAll box" align="center">
		</div>
	</div>
</div>
</body>
