		...
		<div class="row">
			<div class="col-12 col-m-12">
				<div class="col-12 col-m-12 box headBox bgorange">
					<div class="col-m-10">
						<h1 class="NavBar"><?php echo $_SESSION["NomUtilisateur"]; ?> /Inventaire /Consulter /Modifier <?php echo $Data[0]->InvNoId; ?></h1>
					</div>
					<div class="col-m-2">
						<a class="NavBar" href="/index.php/Home/Accueil"><i class="fa fa-chevron-left fa-4x fa-fw" aria-hidden="true"></i></a>
					</div>
				</div>
			</div>
