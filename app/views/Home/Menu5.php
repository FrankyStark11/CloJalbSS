	...
	<div class="row">
		<div class="col-12 col-m-12">
			<div class="col-12 col-m-12 box headBox bgorange">
				<div class="col-m-10">
					<h1 class="NavBar"><?php echo $_SESSION["NomUtilisateur"]; ?> /Configuration /Utilisateurs</h1>
				</div>
				<div class="col-m-2">
		...
		<div class="col-8 col-m-12">
			<h4 class="CLOrange"> <i class="fa clOrange fa-users fa-5x fa-fw" aria-hidden="true"></i></h4><hr>
			<div class="col-12 col-m-12 box">
				<div class="row">

					<a href="/index.php/Home/InsertionUtilisateur">
						<div class="col-l-4 col-6 col-m-12 infobox BtnMenu" align="center">
							<i class="fa clOrange fa-user-plus fa-5x fa-fw" aria-hidden="true"></i>
							<h2>AJOUTER</h2>
						</div>
					</a>

					<a href="/index.php/Home/ConfigUtilisateur">
						<div class="col-l-4 col-6 col-m-12 infobox BtnMenu" align="center">
