	...
	<div class="row Main">
		<div class="col-12 col-m-12">
				<div class="col-12 col-m-12 box headBox bgorange">
					<div class="col-m-10">
						<h1 class="NavBar"><?php echo $_SESSION["NomUtilisateur"]; ?> /Inventaire /Retirer</h1>
					</div>
					<div class="col-m-2">
		...
		<div class="col-4 col-m-12">
			...
			<div class="col-12 box" style="height: 500px;">
				<table class="TabRepceptionHead">
					...
					<tr>
						<td>
							<input id="QteItemReception" type="number" style="text-align: center; font-size: 20px; font-weight: bold;" class="StyleInput col-12" placeholder="Quantité"></input>
						</td>
					</tr>
				</table>
				<table class="Pad">
		...
		<div class="col-12 col-m-12">
			...
			<div  class="col-12 col-m-12  " style="height: 450px;">
				<div  class="col-12 col-m-12 box ">
					<button class="StyleBtn bgorange" style="width: 100%;" onclick="FuncExcelRetrait()" id="BtnEnvoyer" value="Rechercher"> Retirer les pièces </button>
				</div>
			</div>
		</div>
	</div>		
