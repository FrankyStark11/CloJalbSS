	...
	<div class="row">
		...
		<div class="col-6 col-m-12">
			...
			<div class="col-12 col-m-12 box" align="center">
				<h1 class="CLOrange">Confirmation du retrait</h1><br><hr>
				<h2>Numero de confirmation : <?php echo $_SESSION["No"]; ?></h2>
				<a  href="/ConfirmationRetrait/<?php echo $_SESSION["No"]; ?>.xls" target="_blank">
