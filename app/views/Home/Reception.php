	...
	<div class="row Main">
		<div class="col-12 col-m-12">
				<div class="col-12 col-m-12 box headBox bgorange">
					<div class="col-m-10">
						<h1 class="NavBar"><?php echo $_SESSION["NomUtilisateur"]; ?> /Inventaire /Réception</h1>
					</div>
					<div class="col-m-2">
		...
		<div class="col-12 col-m-12">
			...
			<div  class="col-12 col-m-12  " style="height: 450px;">
				<div  class="col-12 col-m-12 box ">
					<button class="StyleBtn bgorange" style="width: 100%;" onclick="FuncExcel()" id="BtnEnvoyer" value="Rechercher"> Recevoir les items </button>
				</div>
			</div>
		</div>
	</div>		
